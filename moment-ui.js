(async () => {
  ...
  try {
    ...
    idle(async()=>{try{await import('./mesraah-voice-appcheck.js?v=0.12.4');await import('./assistant-reliability-v017.js?v=0.17.4');await import('./attachment-pipeline-v0175.js?v=0.17.5');await import('./attachment-bridge-v0175.js?v=0.17.5');await import('./mesraah-voice-tools.js?v=0.12.4');await import('./mesraah-voice-config.js?v=0.12.4');await import('./mesraah-voice.js?v=0.12.4');await import('./mesraah-voice-wake.js?v=0.12.4');stampVersion()}catch(error){console.error('Mesraah deferred assistant engines:',error)}});
