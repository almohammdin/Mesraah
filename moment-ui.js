(async () => {
  ...
  try {
    ...
    await import('./assistant-hub-v0112.js?v=0.18.6');
    window.MesraahVoiceLoadError=null;
    window.MesraahVoiceReady=(async()=>{
      await import('./mesraah-live-appcheck-v0190.js?v=0.19.0');
      await import('./mesraah-live-v0190.js?v=0.19.0');
      if(window.MesraahVoice?.mode!=='gemini-live-majalis')throw new Error('mesraah-live-engine-not-ready');
      return window.MesraahVoice;
    })().catch(error=>{window.MesraahVoiceLoadError=error;console.error('Mesraah Live preload:',error);return null});
    await import('./voice-button-bridge-v0183.js?v=0.19.0');
    ...
    idle(async()=>{try{await import('./firebase-sync.js?v=0.18.0');await import('./assistant-cloud-bridge-v018.js?v=0.18.0');await import('./google-calendar.js?v=0.12.4');await import('./calendar-dedupe-repair-v0191.js?v=0.19.1');await import('./calendar-sync-v0191.js?v=0.19.1');await import('./ui-v080.js?v=0.15.1');stampVersion()}catch(error){console.error('Mesraah deferred services:',error)}});
    idle(async()=>{try{await import('./assistant-reliability-v017.js?v=0.17.4');await import('./attachment-pipeline-v0175.js?v=0.17.5');await import('./attachment-bridge-v0175.js?v=0.17.5');await import('./mesraah-voice-tools.js?v=0.19.0');await import('./mesraah-voice-wake.js?v=0.12.4');stampVersion()}catch(error){console.error('Mesraah deferred assistant engines:',error)}});
