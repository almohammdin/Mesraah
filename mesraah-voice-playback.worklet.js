class MesraahVoicePlayback extends AudioWorkletProcessor {
  constructor() {
    super();
    this.queue = [];
    this.offset = 0;
    this.port.onmessage = event => {
      ...
      if (samples instanceof Float32Array && samples.length) this.queue.push(samples);
    };
  }
...
registerProcessor('mesraah-voice-playback', MesraahVoicePlayback);
