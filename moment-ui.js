(async () => {
  ...
  try {
    ...
    try {
      await import('./mesraah-voice-appcheck-v0190.js?v=0.19.0');
      await import('./mesraah-voice-live-v0190.js?v=0.19.0');
    } catch (voiceError) {
      console.error('Mesraah Gemini voice bootstrap:', voiceError);
    }
