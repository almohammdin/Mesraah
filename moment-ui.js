(async () => {
  ...
  try {
    ...
    idle(async()=>{try{await import('./firebase-sync.js?v=0.18.0');await import('./assistant-cloud-bridge-v018.js?v=0.18.0');await import('./google-calendar.js?v=0.12.4');await import('./calendar-dedupe-repair-v0190.js?v=0.19.0');await import('./calendar-sync-v0190.js?v=0.19.0');await import('./ui-v080.js?v=0.15.1');stampVersion()}catch(error){console.error('Mesraah deferred services:',error)}});
